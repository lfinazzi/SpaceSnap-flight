...
/* Private defines -----------------------------------------------------------*/
#define EXT_CLK_Pin GPIO_PIN_7
#define EXT_CLK_GPIO_Port GPIOF
...
#define IMG_ENA_A_Pin GPIO_PIN_2
#define IMG_ENA_A_GPIO_Port GPIOA
#define IMG_ENA_B_Pin GPIO_PIN_3
#define IMG_ENA_B_GPIO_Port GPIOA
...
#define LS02_RS485_RST_Pin GPIO_PIN_9
